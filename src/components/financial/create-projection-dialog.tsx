...
export function CreateProjectionDialog({
  ...
  const handleInputChange = (field: keyof ProjectionInputs, value: any) => {
    setInputs((prev) => ({
      ...prev,
      [field]: field === "minimumCashThreshold" ? parseInt(value) || 0 : parseFloat(value) || 0,
    }));
  };
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Generated by Joseph AI - Short-term cash flow forecast and analysis
            </DialogDescription>
          </DialogHeader>
                      ...
                      <div className="p-4 bg-red-50 border border-red-200 rounded-lg flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-800">
                            ...
                            <span className="font-semibold">{criticalDays}</span>{" "}
          ...
          <DialogFooter className="flex space-x-3">
            <Button
              variant="outline"
              onClick={() =>
                generatePDFReport(inputs, projection7, projection14, projection30)
              }
            >
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-4">
              <p className="text-sm text-blue-800">
                ...
                with automatic alerts for low cash periods and high-impact dates.
              </p>
            </CardContent>
          </Card>
        </div>
