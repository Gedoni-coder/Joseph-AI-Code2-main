...
interface AddKPIModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (kpi: Omit<PerformanceDriver, "id" | "createdAt" | "lastUpdated" | "kpiHistory">) => void;
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="sticky top-0 bg-white border-b">
          ...
          <CardDescription>Create a new key performance indicator</CardDescription>
        </CardHeader>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-4 border-t pt-4">
            <h3 className="font-semibold text-gray-900">KPI Type & Measurement</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">
                  Driver Type
                </label>
                <Select value={form.driverType} onValueChange={(value: any) => setForm({ ...form, driverType: value })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={form.unitOfMeasure} onValueChange={(value: any) => setForm({ ...form, unitOfMeasure: value })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={form.impact} onValueChange={(value: any) => setForm({ ...form, impact: value })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={form.dataSource} onValueChange={(value: any) => setForm({ ...form, dataSource: value })}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={form.status} onValueChange={(value: any) => setForm({ ...form, status: value })}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="exceeding_target">Exceeding Target</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
